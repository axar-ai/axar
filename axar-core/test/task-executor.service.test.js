...
const query_processor_1 = require("../src/llm/query-processor");
const task_executor_factory_1 = require("../src/task-executor.factory");
const dummySchema = {
    ...
    request: {
        ...
        properties: {
            cityName: {
                type: "string",
                description: "The name of the city for which to retrieve tourist places.",
            },
        },
        required: ["cityName"],
    },
    response: {
        ...
        properties: {
            places: {
                ...
                items: {
                    ...
                    properties: {
                        ...
                        category: {
                            type: "string",
                            description: "The category of the tourist place, e.g., historical, natural, cultural.",
                        },
                    },
                    required: ["name"],
                },
            ...
            message: {
                type: "string",
                description: "An optional message providing additional details about the result.",
            },
        },
...
describe("createTaskExecutor", () => {
    let taskExecutor;
    beforeEach(() => {
        taskExecutor = (0, task_executor_factory_1.createTaskExecutor)({
            llmType: query_processor_1.LLMType.OPENAI,
            credentials: { apiKey: "test-api-key" },
            taskConfig: { modelName: query_processor_1.ModelName.GPT_4O },
        });
    });
